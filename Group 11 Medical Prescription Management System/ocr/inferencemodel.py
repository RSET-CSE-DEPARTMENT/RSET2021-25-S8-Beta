...
if __name__ == "__main__":
    configs = BaseModelConfigs.load(r"D:\xampp\htdocs\doctor_prescription\ocr\Models\04_sentence_recognition\202301131202\configs.yaml")
    model = ImageToWordModel(model_path=configs.model_path, char_list=configs.vocab)

    image_path = r"media\input.jpg"  # Replace with the actual image path 
